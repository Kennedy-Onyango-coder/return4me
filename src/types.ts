...
export const translations = {
  ...
  sw: {
    ...
    verify: {
      lastDigits: 'Nambari 4 za mwisho za hati',
      lastDigitsPlaceholder: 'mfano 4521',
      lastDigitsHelp: 'Hii inasaidia kuthibitisha wewe ni mwenye mali bila kufichua nambari yako kamili ya kitambulisho.',
      passportDigitsPlaceholder: 'mfano 7890',
      cardDigitsPlaceholder: 'mfano 3456',
      cardDigitsHelp: 'Nambari 4 za mwisho zilizochapishwa kwenye kadi.',
      fullName: 'Jina kamili kwenye hati',
      fullNamePlaceholder: 'mfano John Kamau Mwangi',
      plateNumber: 'Nambari ya usajili wa gari',
      plateNumberPlaceholder: 'mfano KDG 123A',
      manufacturer: 'Mtengenezaji / Chapa',
      manufacturerPlaceholder: 'mfano Samsung, Apple, Toyota',
      color: 'Rangi ya bidhaa',
      colorPlaceholder: 'mfano Bluu, Fedha, Nyeusi',
      distinctiveMarks: 'Alama za kutofautisha, mikunjo, au stika',
      distinctiveMarksPlaceholder: 'mfano Ufa kwenye sehemu ya chini kulia, stika ya "Rudisha ikipatikana" nyuma',
      lostLocation: 'Mahali ulipoteza takriban',
      lostLocationPlaceholder: 'mfano Karibu na Yaya Centre, kando ya Barabara ya Uhuru',
      lostDate: 'Tarehe ulipoteza takriban',
      lostDatePlaceholder: 'mfano Juma lililotopea mchana',
      nationality: 'Utaifa',
      nationalityPlaceholder: 'mfano Mkenya',
      bankName: 'Jina la benki',
      bankNamePlaceholder: 'mfano Equity Bank, KCB',
      brand: 'Chapa (ikijulikana)',
      brandPlaceholder: 'mfano Gucci, Louis Vuitton',
      keyCount: 'Idadi ya funguo kwenye shanga',
      keyCountPlaceholder: 'mfano funguo 5',
      institution: 'Jina la taasisi',
      institutionPlaceholder: 'mfano Chuo Kikuu cha Nairobi',
      description: 'Elezea bidhaa',
      descriptionPlaceholder: 'Toa maelezo mengi iwezekanavyo ili kusaidia kuthibitisha umiliki',
      extraDetails: 'Maelezo ya ziada (lini/wapi ulipoteza)',
      extraDetailsPlaceholder: 'mfano Ilipotea ndani ya matatu ya Super Metro kwenda Westlands',
      colorDetail: 'Rangi/maelezo ya jalada',
      colorDetailPlaceholder: 'mfano pochi ya plastiki ya bluu, ganda nyeusi',
    },
